  ...
  return (
    ...
    >
      <div className="min-w-[40px] min-h-[40px] rounded-md gap-2 flex items-center justify-center">
        <Image  className="rounded-full animate-wiggle-more animate-infinite animate-ease-in-out" src={'/Footer.png'} alt="logo" width={110} height={80} />
      </div>
      <motion.ul
        className={`w-full ${
          showNav
      ...
      >
        ...
        <li>
          <Link href={'#english'}>{'//EnglishSong'}</Link>
        </li>
        <li>
        <Link href={'#nepalisong'}>{'//nepali'}</Link>
        </li>

        <li>
        <Link href={'#Beginner'}>{'//drama'}</Link>
        </li>
      </motion.ul>

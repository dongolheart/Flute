...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="min-w-[40px] min-h-[40px] rounded-md gap-2 flex items-center justify-center">
       <a href="#"> <Image  className="rounded-full animate-wiggle-more animate-infinite animate-ease-in-out" src={'/Footer.png'} alt="logo" width={110} height={80} /></a>
      </div>
      <motion.ul
        className={`w-full ${
          showNav
      ...
      >
        ...
        <li>
          <Link href={'#Hindisong'}>{'//Collection of Hindi song'}</Link>
        </li>
        <li>
          <Link href={'#english'}>{'//Collection of EnglishSong'}</Link>
        </li>
        <li>
        <Link href={'#Nepalisong'}>{'//Collection of Nepali'}</Link>
        </li>

        <li>
        <Link href={'#Beginners'}>{'//Beginner'}</Link>
        </li>
      </motion.ul>
